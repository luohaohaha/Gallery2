 ...
 * The source Renderscript file: /Volumes/MacDev/Android/Gallery2-7.1.2-r6/src/com/android/gallery3d/filtershow/filters/saturation.rs
 */
...
public class ScriptC_saturation extends ScriptC {
    ...
    public FieldID getFieldID_colorMatrix_min() {
    ...
    public FieldID getFieldID_colorMatrix_max() {
    ...
    public FieldID getFieldID_satLut() {
