 ...
 * The source Renderscript file: /Volumes/MacDev/Android/Gallery2-7.1.2-r6/src/com/android/gallery3d/filtershow/filters/grad.rs
 */
...
public class ScriptC_grad extends ScriptC {
    ...
    public FieldID getFieldID_mNumberOfLines() {
    ...
    public FieldID getFieldID_mask() {
    ...
    public FieldID getFieldID_xPos1() {
    ...
    public FieldID getFieldID_yPos1() {
    ...
    public FieldID getFieldID_xPos2() {
    ...
    public FieldID getFieldID_yPos2() {
    ...
    public FieldID getFieldID_size() {
    ...
    public FieldID getFieldID_brightness() {
    ...
    public FieldID getFieldID_contrast() {
    ...
    public void forEach_selectiveAdjust(Allocation ain, Allocation aout, LaunchOptions sc) {
        // check ain
